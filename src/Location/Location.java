...
class LocationTest {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < row; i++) {
            System.out.printf("%s%d%s%d%s%n", "Please enter the numbers of row ", i+1, " each number separated by a space. ", column, " numbers needed.");
            lines = line.nextLine();
            //  separates each number inputted by a space and puts them into an array
